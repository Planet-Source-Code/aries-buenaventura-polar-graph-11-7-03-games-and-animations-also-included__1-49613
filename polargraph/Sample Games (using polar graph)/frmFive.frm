...
Private Sub tmrTimer_Timer()
    If Delay <= 0 Then
        ...
        tmrTimer.Interval = tmrTimer.Interval + Speed * 4
    Else
        Delay = Delay - 1
    End If
...
Private Sub Render()
    ...
    For i = LBound(Wheel()) To UBound(Wheel())
        ...
        Wheel(i).Angle = Wheel(i).Angle + OffsetAngle
    ...
    For i = LBound(Wheel()) To UBound(Wheel())
        Radian = (Wheel(i).Angle + OffsetAngle / 2) * PI / 180
    ...
    lblDetails(4).Caption = lblDetails(4).Tag & "30"
